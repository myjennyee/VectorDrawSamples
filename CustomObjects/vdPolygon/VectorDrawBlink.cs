...
namespace VectorDrawCustomFigs
{
    public class VectorDrawBlink : vdShape
    {
        ...
        public VectorDrawBlink(vdDocument doc)
        {
            SetUnRegisterDocument(doc);
            setDocumentDefaults();
            mhatchprops = new vdHatchProperties();
            mhatchprops.SetUnRegisterDocument(doc);
            mhatchprops.FillMode = VdConstFill.VdFillModeSolid;
        }
        ...
        void mtimer_Tick(object sender, EventArgs e)
        {
            ...
            if (Document.ActiveLayOut.OverAllActiveActions != null && Document.ActiveLayOut.OverAllActiveActions.Count > 1) return;
            this.Invalidate();
        ...
        public override Draw3DFlagEnum Draw3DFlag
        {
            get
            {
                return  Draw3DFlagEnum.ExcludeFrom3DList;
            }
            set
            {
                base.Draw3DFlag = Draw3DFlagEnum.ExcludeFrom3DList;
            }
        }
        #endregion
        ...
        public override void GetTableDependecies(vdTableDependeciesArgs args)
        {
            ...
            if (Deleted) return;
            if (this.mhatchprops != null) mhatchprops.GetTableDependecies(args);
        }
        #endregion
    }
